...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7888681022:AAHFqFRAgqeWLuLd5BwQpJGJr1UxRLh6kPA") 

    # database config
    DB_NAME = os.environ.get("DB_NAME","autorename")     
    DB_URL  = os.environ.get("DB_URL","mongodb+srv://Sungjinwoo:aokwjhe-iiwjhhw@cluster0.upj8p.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    ...
    FORCE_SUB   = os.environ.get("FORCE_SUB", "https://t.me/+pdDCnGMDTNc2ZTA1") 
